...
<%-- 						</c:if> --%>
			...
			<tr>
				<td class="base_menu">
					...
					<ul>
						<li><a href="javascript:void(0)" onclick="addTab('Snooker Live', '${ctx}/snooker/score/goToListLivePage.html', ' ');return false;">Snooker Live</a><br/></li>
						<li><a href="javascript:void(0)" onclick="addTab('Snooker Fixture', '${ctx}/snooker/score/goToListFixturePage.html', ' ');return false;">Snooker Fixture</a><br/></li>
